...
<main id="main" class="overflow-x-hidden">
	<div id="primary">
		<section  class="relative lg:h-[100vh] mt-[90px]">
			...
			<div class="container mx-auto px-5 lg:px-24 flex justify-start lg:justify-center items-center h-full relative z-50 !flex-col text-center">
                <div class="shadow-custom rounded-lg lg:p-10 w-full flex items-center flex-col">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">We would love to hear from You.</h2>
                    <p class="text-gray-600 text-md mb-6 lg:w-1/2">
		...
		<div class="relative">
			...
			<section class="my-16 z-60 relative">
				<div class="container mx-auto px-5 lg:px-24 text-center">
					<!-- Heading -->
					<h2 class="text-4xl font-bold text-gray-900 flex flex-col lg:flex-row justify-center items-center gap-2">
						Get in Touch 
					...
					<!-- Contact Boxes -->
					<div  class="grid contact-box-container grid-cols-1 lg:grid-cols-3 gap-8 mt-10">

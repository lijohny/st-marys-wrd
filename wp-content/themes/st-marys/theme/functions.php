...
add_action('init', function () {
    register_post_meta('page', 'footnotes', [
        'show_in_rest' => true, // This is critical for Gutenberg saving
        'single'       => true,
        'type'         => 'string',
        'auth_callback' => '__return_true', // Allow all users with editing capability
    ]);
});
